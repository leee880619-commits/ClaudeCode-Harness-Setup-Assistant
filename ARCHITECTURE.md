...
├── .claude/
│   ├── agents/*.md              ← 12 — phase workers + red-team advisor + ops-auditor + security-auditor (WHO)
...
| 사후 감사 (독립 커맨드) | 기존 하네스 런타임 부채 감사 (`/harness-architect:ops-audit`) | ops-auditor | ops-audit |
